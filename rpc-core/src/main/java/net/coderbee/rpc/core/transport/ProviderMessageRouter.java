...
public class ProviderMessageRouter implements MessageHandler {
    ...
    protected synchronized void addProvider(Provider provider) {
    ...
    public Object handle(Channel channel, Object message) {
        ...
        String serviceKey = request.getAttachment(URLParamType.group) + Constant.PATH_SEPARATOR + request.getClassName()
                + Constant.PATH_SEPARATOR + request.getAttachment(URLParamType.version);
